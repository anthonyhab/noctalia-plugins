...
Item {
  ...
  readonly property bool headerDropdownEnabled: {
    const players = pluginMain?.mediaPlayers || [];
    return players.length > 1;
  }
  readonly property color headerBorderColor: {
    if (isConnected)
        ...
        Item {
          ...
          Rectangle {
            ...
            NText {
              ...
              color: deviceButtonMA.containsMouse ? Color.mOnHover : Color.mOnSurface
    ...
    NBox {
      ...
      ColumnLayout {
        ...
        RowLayout {
          ...
          NIconButton {
            visible: canVolumeMute || canVolumeSet
            icon: volumeLevel === 0 ? "volume-off" : (volumeLevel > 0.5 ? "volume" : "volume-2")
