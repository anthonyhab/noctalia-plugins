...
Item {
    ...
    readonly property var pluginMain: (pluginApi
                                       && pluginApi.mainInstance) || null
    readonly property string panelMode: (pluginMain
                                         && pluginMain.settingsPanelMode)
                                        || "centered"
    ...
    readonly property bool panelAnchorHorizontalCenter: attachToBar ? (barPosition === "top"
                                                                       || barPosition
                                                                       === "bottom") : true
    readonly property bool panelAnchorVerticalCenter: attachToBar ? (barPosition === "left"
                                                                     || barPosition
                                                                     === "right") : true
    readonly property bool panelAnchorTop: attachToBar && barPosition === "top"
    readonly property bool panelAnchorBottom: attachToBar
                                              && barPosition === "bottom"
    readonly property bool panelAnchorLeft: attachToBar
                                            && barPosition === "left"
    readonly property bool panelAnchorRight: attachToBar
                                             && barPosition === "right"

    readonly property int contentPreferredWidth: Math.round(
                                                     360 * Style.uiScaleRatio)
    ...
    AuthContent {
        ...
        busy: (pluginMain && pluginMain.sessionState === "verifying")
              || (pluginMain && pluginMain.sessionState === "submitting")
